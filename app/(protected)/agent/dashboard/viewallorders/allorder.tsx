...
import { ChevronDown, ChevronRight,  Search, MoreVertical, Filter } from "lucide-react"
              ...
              <div className="p-2">
                ...
                {purposeOptions.map((purpose) => (
                  <div
                    key={purpose}
                    className={`px-2 py-1.5 text-sm rounded-md bg-gray-100 cursor-pointer ${
                      purposeFilter === purpose ? "bg-gray-100" : "hover:bg-blue-100"
                    }`}
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem className="flex flex-col items-start">
                                <span className="font-medium">Added by: {order.addedBy || "Agent"}</span>
